...
<%
	...
	feedback=FeedBack.getFeedbackById(feedback.getFeedbackId());
%>
...
<div class="col-md-12 mt-3">
    <div class="card p-4 border-danger border-2" style="background-color:yellow;width: 100%">
        ...
        <div class="card-body">
            <form action="/E-CommerceWebSite/UpdateFeedbackServlet" method="Get">
            
            <input type="hidden" class='form-control' name='feedbackId' value='<%=feedback.getFeedbackId()%>' >
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class='row'>
                    <div class='col-sm-12'>
                        ...
                        <textarea class="form-control" rows="3" cols="10" name="feedback" value="<%=feedback.getFeedback()%>"></textarea>
                    </div>
                </div><br/>
                <center>
